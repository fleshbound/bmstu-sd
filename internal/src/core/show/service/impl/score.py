...
class ScoreService(IScoreService):
    ...
    @staticmethod
    def calc_total(scores: List[ScoreSchema]) -> TotalScoreInfo:
        ...
        return TotalScoreInfo(total=total, count=count, average=avg, min_score=min_score, max_score=max_score)
