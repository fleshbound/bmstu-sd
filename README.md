...
Приложение, имитирующее работу выставочного агенства. Приложение должно предоставлять функционал для хозяев, судьей, организаторов.
...
|Вид|Основная структурная единица биологической систематики животных<br>(Собака, Кошка, Волк, Домашняя лошадь и так далее)|
